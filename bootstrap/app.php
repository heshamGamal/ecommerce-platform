...
return Application::configure(basePath: dirname(__DIR__))
 ...
 ->withExceptions(function(Exceptions $exceptions):void{
  ...
  $exceptions->render(function(PaymentAlreadyProcessedException|InvalidPaymentTransitionException|InvalidOrderStatusTransitionException|OrderActionNotAllowedException $e,Request $r){if($r->is('api/*'))return response()->json(['message'=>$e->getMessage()],409);});
